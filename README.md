...
**Note: You only need to run this the first time you run the script. If you have run the script in the past, DO NOT RUN STEPS 1 or 3. Simply run step 2 to activate your virtual environment.**
